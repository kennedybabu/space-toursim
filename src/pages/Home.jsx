    ...
    <div className='w-full h-screen home'>
        ...
        <div className='grid lg:grid-cols-2 h-full px-[24px]'>
            <div className='flex flex-col justify-center items-center pt-[48px]'>
                ...
                <p className='text-white max-w-[327px] text-center condensed text-[18px] tracking-wide md:max-w-[450px]'>Let's face it, if you want to go to space, you might as well
                    genuinely go outer space and not hover kind of on the edge
                    of it. Well sit back, and relax because we'll give you a 
                    truly out of this world experience!.
                </p>
            </div>
            <div className='flex justify-center lg:items-end pb-[100px]'>
