    ...
    <div className='w-full h-screen text-white technologies overflow-y-hidden'>
      ...
      <div className='h-full w-full grid  text-center lg:grid-cols-2'>
        ...
        <div className='hidden lg:flex items-center justify-center my-4 absolute  left-[4%] top-[36%] flex-col'>
          <Link to='/technologies'><li className='cursor-pointer h-[80px] w-[80px] rounded-full bg-white text-black flex items-center m-2 justify-center'>1</li></Link>
          <Link to='/spaceport'><li className='cursor-pointer h-[80px] w-[80px] rounded-full border-2 border-gray-600 text-white hover:bg-white hover:text-[#0b0d17] hover:border-white flex items-center m-2 justify-center'>2</li></Link>
